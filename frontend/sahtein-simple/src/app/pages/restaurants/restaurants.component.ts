...
export class RestaurantsComponent implements OnInit {
  ...
  getMockRestaurants(): Restaurant[] {
    return [
      ...
      {
        id: 3,
        name_ar: 'مطعم الفرات لأسماك البحر',
        name_en: 'Euphrates Seafood Restaurant',
        description_ar: 'أطباق السمك الطازج من نهر الفرات',
        description_en: 'Fresh fish dishes from Euphrates river',
        category: 'أكولات بحرية',
        address: 'شارع النهر، المركز',
        phone: '+963512345678',
        open_times: '11:00 ص - 11:00 م',
        rating: 4.3,
        is_active: true,
        city: 'دير الزور'
      } as Restaurant & { city: string },
      {
        id: 4,
        name_ar: 'بيتزا منبج الإيطالية',
        name_en: 'Manbij Italian Pizza',
        description_ar: 'بيتزا إيطالية مع لمسة شرقية',
        description_en: 'Italian pizza with Eastern touch',
        category: 'بيتزا',
        address: 'شارع الحرية، وسط المدينة',
        phone: '+963712345678',
        open_times: '12:00 م - 11:00 م',
        rating: 4.2,
        is_active: true,
        city: 'منبج'
      } as Restaurant & { city: string },
      {
        id: 5,
        name_ar: 'شاورما القامشلي الشهيرة',
        name_en: 'Famous Qamishli Shawarma',
        description_ar: 'شاورما لحم ودجاج بالطعم الكردي الأصيل',
        description_en: 'Meat and chicken shawarma with authentic Kurdish taste',
        category: 'شاورما',
        address: 'شارع الوحدة العربية',
        phone: '+963522345678',
        open_times: '8:00 ص - 2:00 ص',
        rating: 4.6,
        is_active: true,
        city: 'القامشلي'
      } as Restaurant & { city: string },
      {
        id: 6,
        name_ar: 'حلويات سلمية الشرقية',
        name_en: 'Salamieh Oriental Sweets',
        description_ar: 'حلويات شرقية وبقلاوة بالفستق الحلبي',
        description_en: 'Oriental sweets and baklava with Aleppo pistachios',
        category: 'حلويات',
        address: 'الشارع الرئيسي، السوق القديم',
        phone: '+963332345678',
        open_times: '7:00 ص - 10:00 م',
        rating: 4.8,
        is_active: true,
        city: 'سلمية'
      } as Restaurant & { city: string },
      {
        id: 7,
        name_ar: 'مطعم تدمر للمأكولات الشعبية',
        name_en: 'Palmyra Traditional Food Restaurant',
        description_ar: 'أطباق شعبية تدمرية أصيلة مع لحم الخروف البدوي',
        description_en: 'Authentic Palmyra folk dishes with Bedouin lamb',
        category: 'مأكولات شعبية',
        address: 'قرب الآثار، الشارع السياحي',
        phone: '+963312345678',
        open_times: '9:00 ص - 9:00 م',
        rating: 4.4,
        is_active: true,
        city: 'تدمر'
      } as Restaurant & { city: string },
      {
        id: 8,
        name_ar: 'مطعم الباب للكبة الحلبية',
        name_en: 'Al Bab Aleppo Kibbeh Restaurant',
        description_ar: 'كبة حلبية بجميع أنواعها والفتة الحلبية',
        description_en: 'All types of Aleppo kibbeh and Aleppo fatteh',
        category: 'مأكولات شعبية',
        address: 'حي المحطة، قرب الجامع الكبير',
        phone: '+963362345678',
        open_times: '10:00 ص - 10:00 م',
        rating: 4.5,
        is_active: true,
        city: 'الباب'
      } as Restaurant & { city: string }
